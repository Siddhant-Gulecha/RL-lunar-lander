...
MODEL_PATH = "tqc_actor_best.pth"  # <--- FIX 1: Load the BEST model
STATS_PATH = "tqc_norm_stats.pth"  # <--- FIX 2: Load normalization stats
...
def test():
    ...
    try:
        # weights_only=False is needed to load numpy arrays safely in newer PyTorch
